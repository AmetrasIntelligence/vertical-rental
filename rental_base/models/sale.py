        ...
        for line in self:
            ...
            if line.rental_type in ("new_rental", "rental_extension"):
                ...
                if line.product_uom_qty != line.sell_rental_id.rental_qty:
                    raise ValidationError(
                        _(
                            "On the sale order line with product {product} "
                ...
                if messages:
                    messages.append(
                        _(
                            ...
                            "Line with product: '{sol.product_id.display_name}'\n\n"
